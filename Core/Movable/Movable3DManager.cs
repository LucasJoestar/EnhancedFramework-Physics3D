...
namespace EnhancedFramework.Physics3D {
    ...
    public sealed class CollisionOperationData3D {
        ...
        /// </summary>
        public void Init(Physics3DSettings _physicsSettings, Movable3D _movable, Vector3 _position, FrameVelocity _frameVelocity, bool _performCollisions, IList<Collider> _selfColliders) {
