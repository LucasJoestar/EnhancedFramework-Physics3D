...
namespace EnhancedFramework.Physics3D {
    ...
    internal abstract class ColliderWrapper3D {
        ...
        /// <summary>
        /// Refreshes this collider associated <see cref="Transform"/> position based on its <see cref="Rigidbody"/> position.
        /// </summary>
    ...
    internal sealed class BoxColliderWrapper3D : ColliderWrapper3D {
        ...
        public override Vector3 GetExtents() {
            ...
            Transform _transform = transform;
            Vector3 _extents = _transform.RelativeVector(_transform.TransformVector(collider.size * .5f));
